...
// - onSetLanguageResponse: Language update response with updated configuration
//
// Key Features:
...
class RdnaEventManager {
  ...
  // Language Management Handler Setters
  ...
  void cleanup() {
    ...
    // Clear language management handlers
