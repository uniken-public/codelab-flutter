...
import 'uniken/providers/push_notification_provider.dart';
import 'uniken/components/threat_detection_modal.dart';
import 'uniken/components/modals/session_modal.dart';
import 'dart:io' show Platform;

void main() {
  runApp(
    const ProviderScope(
      child: PushNotificationProvider(
        child: MyApp(),
      ),
    ),
  );
...
/// - **PushNotificationProvider for FCM integration** ← NEW FEATURE
...
class MyApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Watch Session state for global session modal display
